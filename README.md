...
```yaml
remote_theme: zhiweichen0012/zhiweichen0012.github.io
```
...
```bash
git clone git@github.com:zhiweichen0012/zhiweichen0012.github.io.git
cd zhiweichen0012.github.io
```
Install and run:
...
This work is licensed under a [Creative Commons Zero v1.0 Universal](https://github.com/zhiweichen0012/zhiweichen0012.github.io/blob/main/LICENSE) License.
